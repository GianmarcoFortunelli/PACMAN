...
void LCD_DrawSquare (uint16_t x0, uint16_t y0, uint16_t side , uint16_t color )
{
    LCD_DrawLine(x0,y0,x0+side,y0,color);
		LCD_DrawLine(x0+side,y0,x0+side,y0+side,color);
		LCD_DrawLine(x0,y0+side,x0+side,y0+side,color);
		LCD_DrawLine(x0,y0,x0,y0+side,color);
		LCD_DrawLine(x0,y0,x0+side,y0+side,color);
		LCD_DrawLine(x0+side,y0,x0,y0+side,color);
} 

void LCD_DrawCircle (uint16_t x0, uint16_t y0, uint16_t rad , uint16_t color )
{		
		int i,j,xC, yC, dx, dy;
		xC=x0+5;
		yC=y0+5;
